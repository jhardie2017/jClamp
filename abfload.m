...
% 
% ADDITIONS SINCE LAST OFFICIAL VERSION POSTED ON MATLABFILEEXCHANGE
% + Feb 2013:
% name & path of protocol file appended to field 'protocolName' of header
% structure h (lines ~320ff)
% + May 2013: warning if variable goodstart has less or more than exactly
% one entry changed to error if goodstart is empty (in code dealing with
% strings section)
